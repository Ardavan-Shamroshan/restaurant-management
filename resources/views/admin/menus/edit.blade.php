        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.menus.index') }}"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">لیست منو ها</a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.update', $menu->id) }}"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div>
                                <img class="w-32 h-32" src="{{ asset($menu->image) }}">
                            </div>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <label for="body" class="block text-sm font-medium text-gray-700">توضیح</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <label for="categories" class="block text-sm font-medium text-gray-700">دسته بندی</label>
                            <div class="mt-1">
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit"
                                class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">ویرایش</button>
                        </div>
                    </form>
                </div>
